...
import { ContractAbi } from '../contract-info/admin';
import QueryMethods from '../query/admin';
import BuildExtrinsicMethods from '../build-extrinsic/admin';
import TxSignAndSendMethods from '../tx-sign-and-send/admin';
import MixedMethods from '../mixed-methods/admin';
import EventsClass from '../events/admin';
