...
export declare class ArchiveApi implements ExploreApi {
    private log?;
    private archive;
    constructor(url: string, log?: Logger | undefined);
    ...
    private versionRecords;
    private request;
    fetchVersions(): Promise<SpecVersion[]>;
}
//# sourceMappingURL=archiveApi.d.ts.map