...
class Runner {
    ...
    archiveRequest() {
        ...
        class ArchiveClient extends util_internal_http_client_1.HttpClient {
        ...
        let http = new ArchiveClient({
            ...
            agent: new util_internal_http_client_1.HttpAgent({
                keepAlive: true
            }),
        ...
        return archiveQuery => {
            return http.graphqlRequest(archiveQuery).catch((0, util_internal_1.withErrorContext)({ archiveQuery }));
        };
    }
    chainManager() {
...
__decorate([
    ...
    __metadata("design:returntype", util_internal_resilient_rpc_1.RpcClient)
