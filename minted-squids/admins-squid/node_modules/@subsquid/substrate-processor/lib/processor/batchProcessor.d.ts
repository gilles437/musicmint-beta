...
export type BatchProcessorEventItem<T> = Extract<BatchProcessorItem<T>, {
    kind: 'event';
}>;
export type BatchProcessorCallItem<T> = Extract<BatchProcessorItem<T>, {
    kind: 'call';
}>;
...
export declare class SubstrateBatchProcessor<Item extends {
    ...
    addEthereumTransaction(contractAddress: string | string[], options?: {
        range?: Range;
        sighash?: string;
    } & NoDataSelection): SubstrateBatchProcessor<AddCallItem<AddEventItem<Item, EventItem<"Ethereum.Executed", true>>, CallItem<"Ethereum.transact", true>>>;
    addEthereumTransaction<R extends CallDataRequest>(contractAddress: string | string[], options: {
        range?: Range;
        sighash?: string;
    } & DataSelection<R>): SubstrateBatchProcessor<AddCallItem<AddEventItem<Item, EventItem<"Ethereum.Executed", true>>, CallItem<"Ethereum.transact", R>>>;
    /**
     * Similar to {@link .addEvent},
