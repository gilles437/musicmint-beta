...
export type CodecType = PrimitiveType | SequenceType | BitSequenceType | ArrayType | TupleType | OptionType | DoNotConstructType | CodecCompactType | CodecStructType | CodecVariantType | CodecBytesType | CodecBytesArrayType | CodecBooleanOptionType;
